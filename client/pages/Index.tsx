          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Análise inteligente de perfis e matching de candidatos
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Candidatos com melhor compatibilidade
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <TabsContent value="analytics">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Insights detalhados sobre contratações e performance
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Esta seção incluirá gráficos interativos, métricas de
                    performance e insights preditivos.
                  </p>
          ...
          <TabsContent value="reports">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Gere relatórios personalizados sobre contratações e candidatos
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Crie relatórios detalhados com dados de contratação, tempo
                    médio de preenchimento de vagas e análise de ROI.
                  </p>
