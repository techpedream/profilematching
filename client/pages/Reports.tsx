          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Gere relatórios personalizados sobre contratações e performance
              </p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-lg">
              Esta página incluirá geração automática de relatórios, exportação
              de dados e análises personalizadas.
            </CardDescription>
          </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Gere relatórios padronizados instantaneamente
                </p>
              </div>
              <div className="text-center p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Exporte em PDF, Excel e outros formatos
                </p>
              </div>
              <div className="text-center p-4 border rounded-lg">
